...
@client.event    
async def on_ready():
    print('[Log] Bot has authenticated and started successfully, awaiting command "!syncinvites" (type command in Discord server to start the process)')
